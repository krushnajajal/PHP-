...
<body>
    ...
    <?php
        $result=mysqli_query($conn,"select * from del_db");
        while($row=mysqli_fetch_assoc($result)){
            ?><tr>
            <td><?php echo $row['id']?><br></td>
            <td><?php echo $row['name']?></td>
            <td><a href="delete.php?id=<?php echo $row['id'];?>" onclick="return confirm('Delete this record?')">Delete</a>
            | <a href="form.php?id=<?php echo $row['id'];?>" >Update</a></td>
